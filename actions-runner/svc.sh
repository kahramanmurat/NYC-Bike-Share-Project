...
SVC_NAME="actions.runner.kahramanmurat-NYC-Bike-Share-Project.self-hosted.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (kahramanmurat-NYC-Bike-Share-Project.self-hosted)"
